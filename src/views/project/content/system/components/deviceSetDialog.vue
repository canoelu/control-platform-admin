  ...
  >
    <div v-loading="loading">
      <common-form
        ref="formRef"
        :form="systemForm"
        :rules="constant.DEVICE_SET_RULES"
        :props="constant.DEVICE_SET_PROPS"
      >
      </common-form>
      <div class="flexCenter">
        <el-button size="small" @click="handleClose">关闭</el-button>
        <el-button size="small" type="primary" @click="handleSave" :loading="saving">确认</el-button>
        <el-button size="small" type="error" @click="handleSave" :loading="deleteSysDevice">删除</el-button>
      </div>
    </div>
  </el-dialog>
</template>
